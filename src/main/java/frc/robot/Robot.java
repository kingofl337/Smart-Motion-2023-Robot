...
public void disabledPeriodic(){
  SmartDashboard.putNumber("Encoder Posistion",  m_encoder.getPosition());
}
  ...
  public void teleopPeriodic() {
    ...
    double allE = SmartDashboard.getNumber("Encoder Posistion", 0);
    ...
    if(mode) {
       ...
       */
      m_pidController.setReference(setPoint, CANSparkMax.ControlType.kSmartMotion, 0);
